...
class ConfirmTItemMergeBanner extends Component {
   constructor(props) {
      super(props);
   ...
   onClickConfirmMerge = () => {
      ...
      axios.post('/templates/textitem/merge', { winnerOfMerge: textItemId, loserOfMerge: this.merge_loser })
         .then(() => {
      ...
      if (isMergeMode) return (
         <div className="content mb-5">
            ...
            <div className="row no-gutters">
               ...
               <Link className="btn btn-outline-dark" to='/app/content/item-text/browse'>Cancel</Link>
            </div>
         </div>
      );
      else return null;
...
export default withRouter(ConfirmTItemMergeBanner);
